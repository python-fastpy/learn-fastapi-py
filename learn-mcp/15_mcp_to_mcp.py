...
WHY THIS MATTERS:
  ...
  the same Client + StreamableHttpTransport from lesson 02, but *inside*
...
if __name__ == "__main__":
    ...
    # -- Key takeaway --------------------------------------------------------
    # MCP-to-MCP is just the one-shot client pattern from lesson 07, used
    ...
    #    (reuse the pattern from lesson 07's call_with_retry)
    # 3. Forward the quote-check result as a _meta.forwarded_blocks entry
    #    instead of inlining it (combine lesson 09 + this lesson)
