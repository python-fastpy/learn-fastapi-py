...
WHAT YOU'LL LEARN:
  1. Agent vs MCP -- which layer does what, and why MCP works with zero
     agents involved (lessons 01-06 never touched an LLM)
...
# it's done. In production this decision is made by an LLM (lesson 07's
...
if __name__ == "__main__":
    ...
    #   should even handle this). Lessons 01-06 proved MCP works with zero
    ...
    #      get interrupted (lesson 09/10), or need to resume independently.
    #
