...
| 04 Guardrails on tool/document content | `learn-mcp` lesson 08's `_meta.forwarded_blocks` separates agent-visible from UI-visible content — guardrails apply the same instinct to trust, not visibility |
