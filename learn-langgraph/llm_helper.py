...
def get_llm(model: str = "gpt-4o", temperature: float = 0.05) -> AzureChatOpenAI:
    ...
    This is what every lesson imports. It handles:
      - Azure AD token auth (same client-credentials flow as the skills)
      - Correct deployment paths + custom orchestrator headers
      - Model-specific API version selection
    ...
    Returns:
        AzureChatOpenAI instance ready for LangGraph.
    """
    ...
    default_headers = {
        ...
        "x-tr-sessionid": "learn-langgraph",
