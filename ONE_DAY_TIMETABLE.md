...
| 10:20 - 11:00 | 3. Tools, Resources, Prompts | `learn-mcp/03_tools_resources_prompts.py` | All three MCP primitives: `@mcp.tool`, `@mcp.resource`, `@mcp.prompt` | Skills expose tools; workflows loaded as resources |
